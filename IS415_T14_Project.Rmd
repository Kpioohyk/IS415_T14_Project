...
Visualise Dendogram
```{r}
plot(hclust_ward, cex = 0.3)#can try to drop labels
```
...
```
Maybe can explore the statistical test he used in class to see if this is randomly distributed. 

## 5.2 Spatially Constrained Clustering 
