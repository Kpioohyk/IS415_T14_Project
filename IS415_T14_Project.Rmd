...
packages = c('sf','spdep','rgdal','tmap','tidyverse', 'cluster', 'NbClust', 'heatmaply', 'corrplot','factoextra', 'lubridate', 'ggpubr', 'ClustGeo', "geodist")
for (p in packages){
...
var_meaning4 <- c("SHAPE",
         ...
         "CAUSE_FIGHT_COMMUNITY_GRP",
         
         "TOTAL_FIGHT_RURAL_COMMUNITY",
         "FIGHT_RURAL_COMMUNITY_DIED",
         "FIGHT_RURAL_COMMUNITY_INJURED",
         "CAUSE_FIGHT_RURAL_COMMUNITY",
         
         "TOTAL_FIGHT_SECURITY_FORCE",
         "FIGHT_SECURITY_FORCE_DIED",
         "FIGHT_SECURITY_FORCE_INJURED",
         "CAUSE_FIGHT_SECURITY_FORCE",
         
         "TOTAL_FIGHT_GOVT_OFFICIAL",
         "FIGHT_GOVT_OFFICIAL_DIED",
         "FIGHT_GOVT_OFFICIAL_INJURED",
         "CAUSE_FIGHT_GOVT_OFFICIAL",
         
         "TOTAL_FIGHT_STUDENT",
         "FIGHT_STUDENT_DIED",
         "FIGHT_STUDENT_INJURED",
         "CAUSE_FIGHT_STUDENT" ,
         
         "TOTAL_FIGHT_ETHNIC_GROUP",
         "FIGHT_ETHNIC_GROUP_DIED",
         "FIGHT_ETHNIC_GROUP_INJURED",
         "CAUSE_FIGHT_ETHNIC_GROUP",
         
         "TOTAL_FIGHT_OTHERS",
         "FIGHT_OTHERS_DIED",
         "FIGHT_OTHERS_INJURED",
         "CAUSE_FIGHT_OTHERS",
         ...
         "ACTIVATION_OF_CITIZEN_SECURITY_SYSTEM",
         "NUM_CIVIL_DEFENSE_OFFICER", 
         "PRESENCE_POLICE_STATION_OFFICE",
         "NUM_OF_POLICE_STATION_USED",
         "NUM_OF_POLICE_STATION_NOT_USED",
         "DISTANCE_TO_NEAREST_POLICE_STATION_KM",
         "CONVENIENCE_TO_NEAREST_POLICE_STATION",
         "NUM_SUICIDE_VICTIM",
         "PRESENCE_STREET_CHILDREN_GATHERING_PLACE",  
         "PRESENCE_HOMELESS_BEGGAR_GATHERING_PLACE", 
         "PRESENCE_SEX_WORKERS",  
         "VILLAGE_INFORMATION_SYSTEM",  
         ...
         "VILLAGE_HEAD_REGULATION_2017", 
         "COOPERATION_BETWEEN_VILLAGES_2018",  
         "VILLAGE_COOPERATION_WITH_THIRD_PARTIES_2018",  
         "PRESENCE_VILLAGE_GUIDES",   
         "TRANSPORTATION_INFRASTRUCTURE_DEVELOPMENT", 
         "SOURCE_FUND_TRANSPORT",
         "ADMINISTRATOR_TRANSPORT",
         "BENEFIT_RECEIVER_TRANSPORT",
         "ENERGY_INFRASTRUCTURE",
         "SOURCE_FUND_ENERGY",
         "ADMINISTRATOR_ENERGY",
         "BENEFIT_RECEIVER_ENERGY",
         "INFO_COMM_INFRASTRUCTURE",
         "SOURCE_FUND_INFO_COMM",
         "ADMINISTRATOR_INFO_COMM",
         "BENEFIT_RECEIVER_INFO_COMM",
         "SANITATION_INFRASTRUCTURE",
         "SOURCE_FUND_SANITATION",
         "ADMINISTRATOR_SANITATION",
         "BENEFIT_RECEIVER_SANITATION",
         "EDUCATION_CULTURE_HEALTH_INFRASTRUCTURE",
         "SOURCE_FUND_EDUCATIONCULTURE",
         "ADMINISTRATOR_EDUCATIONCULTURE",
         "BENEFIT_RECEIVER_EDUCATIONCULTURE",
         "TRADING_SERVICES_INFRASTRUCTURE",
         "SOURCE_FUND_TRADING",
         "ADMINISTRATOR_TRADING",
         "DIRECT_BENEFIT_RECEIVER6",
         "FARMING_PRODUCTION_SMALL_INDUSTRY_INFRASTRUCTURE",
         "SOURCE_FUND_FARMING_SMALL_INDUSTRY",
         "ADMINISTRATOR_FARMING_SMALL_INDUSTRY",
         "BENEFIT_RECEIVER_FARMING_SMALL_INDUSTRY",
         "RECREATION_TOURISM_INFRASTRUCTURE",
         "SOURCE_FUND_RECREATION",
         "ADMINISTRATOR_RECREATION",
         "BENEFIT_RECEIVER_RECREATION",
         "DISASTER_MITIGATION_ENV_CONSERVATION_INFRASTRUCTURE",
         "SOURCE_FUND_DISASTER_MITIGATION",
         "ADMINISTRATOR_DISASTER_MITIGATION",
         "BENEFIT_RECEIVER_DISASTER_MITIGATION",
         "GOVT_SUPPORT_INFRASTRUCTURE",
         "SOURCE_FUND_GOVT_INFRASTRUCTURE",
         "ADMINISTRATOR_GOVT_SUPPORT",
         "BENEFIT_RECEIVER_GOVT_SUPPORT",
         "EDU_HEALTH_CULTURE_EMPOWERMENT",
         "SOURCE_FUND_SOCIAL_EMPOWERMENT",
         "ADMINISTRATOR_SOCIAL_EMPOWERMENT",
         "BENEFIT_RECEIVER_SOCIAL_EMPOWERMENT",
         "RESIDENTIAL_NEIGHBOURHOOD_EMPOWERMENT",
         "SOURCE_OF_FUND_RESIDENTIAL_EMPOWERMENT",
         "ADMINISTRATOR_RESIDENTIAL_EMPOWERMENT",
         "BENEFIT_RECEIVER_RESIDENTIAL_EMPOWERMENT",
         "TRANSPORTATION_EMPOWERMENT",
         "SOURCE_FUND_TRANSPORTATION_EMPOWERMENT",
         "ADMINISTRATOR_TRANSPORTATION_EMPOWERMENT",
         "BENEFIT_RECEIVER_TRANSPORTATION_EMPOWERMENT",
         "RENEWABLE_ENERGY_EMPOWERMENT",
         "SOURCE_FUND_ENERGY_EMPOWERMENT",
         "ADMINISTRATOR_ENERGY_EMPOWERMENT",
         "BENEFIT_RECEIVER_ENERGY_EMPOWERMENT",
         "INFO_COMM_EMPOWERMENT",
         "SOURCE_FUND_INFO_COMM_EMPOWERMENT",
         "ADMINISTRATOR_INFO_COMM_EMPOWERMENT",
         "BENEFIT_RECEIVER_INFO_COMM_EMPOWERMENT",
         "AGRI_BUSINESS_NON_AGRI_SMALL_BUSI_EMPOWERMENT",
         "SOURCE_FUND_AGRI_BUSINESS_EMPOWERMENT",
         "ADMINISTRATOR_AGRI_BUSINESS_EMPOWERMENT",
         "BENEFIT_RECEIVER_AGRI_BUSINESS_EMPOWERMENT",
         "DISASTER_MITIGATION_ENV_CONSERVATION_EMPOWERMENT",
         "SOURCE_FUND_ENV_CONSERVATION_EMPOWERMENT",
         "ADMINISTRATOR_ENV_CONSERVATION_EMPOWERMENT",
         "BENEFIT_RECEIVER_ENV_CONSERVATION_EMPOWERMENT",
         "COMMUNITY_INVOLVEMENT_VILLAGE_GOVERNANCE_EMPOWERMENT",
         "SOURCE_FUND_GOVERNANCE_EMPOWERMENT",
         "ADMINISTRATOR_GOVERNANCE_EMPOWERMENT",
         "BENEFIT_RECEIVER_GOVERNANCE_EMPOWERMENT",
         "VILLAGE_CAPACITY_EMPOWERMENT",
         "SOURCE_FUND_VILLAGE_CAPACITY",
         "ADMINISTRATOR_VILLAGE_CAPACITY",
         "BENEFIT_RECEIVER_VILLAGE_CAPACITY",
         "VILLAGE_ENTERPRISE_EMPOWERMENT",
         "SOURCE_FUND_VILLAGE_ENTERPRISE",
         "ADMINISTRATOR_VILLAGE_ENTERPRISE",
         "BENEFIT_RECEIVER_VILLAGE_ENTERPRISE",
         "PRESENCE_VILLAGE_HEAD",
         "VILLAGE_HEAD_AGE",  
         "VILLAGE_HEAD_GENDER",  
         "VILLAGE_HEAD_EDUCATION_LEVEL", 
         "PRESENCE_VILLAGE_SECRETARY", 
         "VILLAGE_SECRETARY_AGE", 
         "VILLAGE_SECRETARY_GENDER", 
         "VILLAGE_SECRETARY_EDUCATION_LEVEL",
         "VILLAGE_SECRETARIAT",  
         "TECHNICAL_HEAD", 
         "TERRITORIAL_HEAD", 
         "VILLAGE_OFFICIALS")
...
Now, let's rename the column names of podes1 with the column names vector `var_meaning4`.
...
Let's download/write the final podes data into a csv data so that we can read it in the shiny app.R file.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
head(podes)
write.csv(podes, "podes_final.csv", sep = ",")
```
...
We can see that the podes data frame have 751 variables now, and it's correct because if we bind everything it will have 784 variables and subtracted by 3 times of 9 same variable will be 778-27 = 751.
...
```{r}
colnames(podes.subset)
```

## Combining polygons based on city and district level for R shiny

To save the data to Rda file to load to R shiny app for choropleth maps border

###  City/Regency level border

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=TRUE}
city <- unique(area$CITY)

city1 <- area %>%
  filter(CITY == "KUTAI KARTANEGARA") %>%
  st_combine()

city2 <- area %>%
  filter(CITY == "PENAJAM PASER UTARA") %>%
  st_combine()

city3 <- area %>%
  filter(CITY == "BALIKPAPAN") %>%
  st_combine()

city4 <- area %>%
  filter(CITY == "SAMARINDA") %>%
  st_combine()

city_border1 <- st_as_sf(st_union(city1, by_feature = TRUE))
city_border2 <- st_as_sf(st_union(city2, by_feature = TRUE))
city_border3 <- st_as_sf(st_union(city3, by_feature = TRUE))
city_border4 <- st_as_sf(st_union(city4, by_feature = TRUE))
city_border <- rbind(city_border1, city_border2, city_border3, city_border4)
qtm(city_border)
```

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=TRUE}
save(city_border, file = "city_border.Rda")
```


### District level border

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=TRUE}
district <- unique(area$DISTRICT)

district1 <- area %>%
  filter(DISTRICT == "SEMBOJA") %>%
  st_combine()
district2 <- area %>%
  filter(DISTRICT == "MUARA JAWA") %>%
  st_combine()
district3 <- area %>%
  filter(DISTRICT == "SANGA-SANGA") %>%
  st_combine()
district4 <- area %>%
  filter(DISTRICT == "LOA JANAN") %>%
  st_combine()


district5 <- area %>%
  filter(DISTRICT == "LOA KULU") %>%
  st_combine()
district6 <- area %>%
  filter(DISTRICT == "MUARA MUNTAI") %>%
  st_combine()
district7 <- area %>%
  filter(DISTRICT == "MUARA WIS") %>%
  st_combine()
district8 <- area %>%
  filter(DISTRICT == "KOTABANGUN") %>%
  st_combine()


district9 <- area %>%
  filter(DISTRICT == "TENGGARONG") %>%
  st_combine()
district10 <- area %>%
  filter(DISTRICT == "SEBULU") %>%
  st_combine()
district11 <- area %>%
  filter(DISTRICT == "TENGGARONG SEBERANG") %>%
  st_combine()
district12 <- area %>%
  filter(DISTRICT == "ANGGANA") %>%
  st_combine()

district13 <- area %>%
  filter(DISTRICT == "MUARA BADAK") %>%
  st_combine()
district14 <- area %>%
  filter(DISTRICT == "MARANG KAYU") %>%
  st_combine()
district15 <- area %>%
  filter(DISTRICT == "MUARA KAMAN") %>%
  st_combine()
district16 <- area %>%
  filter(DISTRICT == "KENOHAN") %>%
  st_combine()

district17 <- area %>%
  filter(DISTRICT == "KEMBANG JANGGUT") %>%
  st_combine()
district18 <- area %>%
  filter(DISTRICT == "TABANG") %>%
  st_combine()
district19 <- area %>%
  filter(DISTRICT == "BABULU") %>%
  st_combine()
district20 <- area %>%
  filter(DISTRICT == "WARU") %>%
  st_combine()

district21 <- area %>%
  filter(DISTRICT == "PENAJAM") %>%
  st_combine()
district22 <- area %>%
  filter(DISTRICT == "SEPAKU") %>%
  st_combine()
district23 <- area %>%
  filter(DISTRICT == "BALIKPAPAN SELATAN") %>%
  st_combine()
district24 <- area %>%
  filter(DISTRICT == "BALIKPAPAN KOTA") %>%
  st_combine()

district25 <- area %>%
  filter(DISTRICT == "BALIKPAPAN TIMUR") %>%
  st_combine()
district26 <- area %>%
  filter(DISTRICT == "BALIKPAPAN UTARA") %>%
  st_combine()
district27 <- area %>%
  filter(DISTRICT == "BALIKPAPAN TENGAH") %>%
  st_combine()
district28 <- area %>%
  filter(DISTRICT == "BALIKPAPAN BARAT") %>%
  st_combine()

district29 <- area %>%
  filter(DISTRICT == "PALARAN") %>%
  st_combine()
district30 <- area %>%
  filter(DISTRICT == "SAMARINDA ILIR") %>%
  st_combine()
district31 <- area %>%
  filter(DISTRICT == "SAMARINDA KOTA") %>%
  st_combine()
district32 <- area %>%
  filter(DISTRICT == "SAMBUTAN") %>%
  st_combine()

district33 <- area %>%
  filter(DISTRICT == "SAMARINDA SEBERANG") %>%
  st_combine()
district34 <- area %>%
  filter(DISTRICT == "LOA JANAN ILIR") %>%
  st_combine()
district35 <- area %>%
  filter(DISTRICT == "SUNGAI KUNJANG") %>%
  st_combine()
district36 <- area %>%
  filter(DISTRICT == "SAMARINDA ULU") %>%
  st_combine()
district37 <- area %>%
  filter(DISTRICT == "SAMARINDA UTARA") %>%
  st_combine()
district38 <- area %>%
  filter(DISTRICT == "SUNGAI PINANG") %>%
  st_combine()

dist_border1 <- st_as_sf(st_union(district1, by_feature = TRUE))
dist_border2 <- st_as_sf(st_union(district2, by_feature = TRUE))
dist_border3 <- st_as_sf(st_union(district3, by_feature = TRUE))
dist_border4 <- st_as_sf(st_union(district4, by_feature = TRUE))

dist_border5 <- st_as_sf(st_union(district5, by_feature = TRUE))
dist_border6 <- st_as_sf(st_union(district6, by_feature = TRUE))
dist_border7 <- st_as_sf(st_union(district7, by_feature = TRUE))
dist_border8 <- st_as_sf(st_union(district8, by_feature = TRUE))

dist_border9 <- st_as_sf(st_union(district9, by_feature = TRUE))
dist_border10 <- st_as_sf(st_union(district10, by_feature = TRUE))
dist_border11 <- st_as_sf(st_union(district11, by_feature = TRUE))
dist_border12 <- st_as_sf(st_union(district12, by_feature = TRUE))

dist_border13 <- st_as_sf(st_union(district13, by_feature = TRUE))
dist_border14 <- st_as_sf(st_union(district14, by_feature = TRUE))
dist_border15 <- st_as_sf(st_union(district15, by_feature = TRUE))
dist_border16 <- st_as_sf(st_union(district16, by_feature = TRUE))

dist_border17 <- st_as_sf(st_union(district17, by_feature = TRUE))
dist_border18 <- st_as_sf(st_union(district18, by_feature = TRUE))
dist_border19 <- st_as_sf(st_union(district19, by_feature = TRUE))
dist_border20 <- st_as_sf(st_union(district20, by_feature = TRUE))

dist_border21 <- st_as_sf(st_union(district21, by_feature = TRUE))
dist_border22 <- st_as_sf(st_union(district22, by_feature = TRUE))
dist_border23 <- st_as_sf(st_union(district23, by_feature = TRUE))
dist_border24 <- st_as_sf(st_union(district24, by_feature = TRUE))

dist_border25 <- st_as_sf(st_union(district25, by_feature = TRUE))
dist_border26 <- st_as_sf(st_union(district26, by_feature = TRUE))
dist_border27 <- st_as_sf(st_union(district27, by_feature = TRUE))
dist_border28 <- st_as_sf(st_union(district28, by_feature = TRUE))

dist_border29 <- st_as_sf(st_union(district29, by_feature = TRUE))
dist_border30 <- st_as_sf(st_union(district30, by_feature = TRUE))
dist_border31 <- st_as_sf(st_union(district31, by_feature = TRUE))
dist_border32 <- st_as_sf(st_union(district32, by_feature = TRUE))

dist_border33 <- st_as_sf(st_union(district33, by_feature = TRUE))
dist_border34 <- st_as_sf(st_union(district34, by_feature = TRUE))
dist_border35 <- st_as_sf(st_union(district35, by_feature = TRUE))
dist_border36 <- st_as_sf(st_union(district36, by_feature = TRUE))
dist_border37 <- st_as_sf(st_union(district37, by_feature = TRUE))
dist_border38 <- st_as_sf(st_union(district38, by_feature = TRUE))


district_border <- rbind(dist_border1, dist_border2, dist_border3, dist_border4,
                         dist_border5, dist_border6, dist_border7, dist_border8,
                         dist_border9, dist_border10, dist_border11, dist_border12,
                         dist_border13, dist_border14, dist_border15, dist_border16,
                         dist_border17, dist_border18, dist_border19, dist_border20,
                         dist_border21, dist_border22, dist_border23, dist_border24,
                         dist_border25, dist_border26, dist_border27, dist_border28,
                         dist_border29, dist_border30, dist_border31, dist_border32,
                         dist_border33, dist_border34, dist_border35, dist_border36,
                         dist_border37, dist_border38)
qtm(district_border)
```

```{r}
save(district_border, file = "district_border.Rda")
```

# 3.7 Combining spatial and aspatial data

We will join the `area` shapefile of East Kalimantan boundary with the tidied podes dataset so that we can do further analysis. Our common variables between `area` and `podes` dataframes have different data types so we have to change the `podes'` variable into character type.
...
Then, we perform innerjoin.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
eastkalimantan.podes <- inner_join(area, podes, by = c("PROVINCE_ID", "CITY_ID", "DISTRICT_ID", "VILLAGE_ID", "PROVINCE", "CITY", "DISTRICT", "VILLAGE")) 
eastkalimantan.podes <- as.data.frame(eastkalimantan.podes)
head(eastkalimantan.podes)
```
...
## 3.7.1 Examining the joined dataframes

```{r}
#glimpse(eastkalimantan.podes)
```

```{r}
#glimpse(eastkalimantan.podes.subset)
```
...
```{r}
str(eastkalimantan.podes.subset)
```
...
```{r}
#identify which observation contains NA
# then proceed to get the sum of na in each variable/column
# if the sum of na in a column is more than 0, pick out the column names
...
for (colname in factorised_cols) {
  col <- as.data.frame(eastkalimantan.podes.subset %>% select(colname)) #select column names, make it a data frame
...
any(is.na.data.frame(eastkalimantan.podes.subset))
```
Note: All NA values are successfully replaced. 
...
ekps.recoded <- ekps.recoded %>%
  ...
  mutate(`INFRA_DEVELOPMENT_SCORE` = TRANSPORTATION_INFRASTRUCTURE_DEVELOPMENT + INFO_COMM_INFRASTRUCTURE + SANITATION_INFRASTRUCTURE + EDUCATION_CULTURE_HEALTH_INFRASTRUCTURE + TRADING_SERVICES_INFRASTRUCTURE + FARMING_PRODUCTION_SMALL_INDUSTRY_INFRASTRUCTURE + RECREATION_TOURISM_INFRASTRUCTURE + DISASTER_MITIGATION_ENV_CONSERVATION_INFRASTRUCTURE + GOVT_SUPPORT_INFRASTRUCTURE) %>%
...
```{r}
colnames(ekps.recoded)
```


```{r}
unique(ekps.recoded$CITY)
```
...
this is for LQ calculation

Now let's calculate the total 

apply LQ onto different industry independently, total would be the sum of related industry 

4 city - "KUTAI KARTANEGARA"   "PENAJAM PASER UTARA" "BALIKPAPAN"          "SAMARINDA"  


<!-- ```{r} -->
<!-- LQ <- ekps.recoded %>% -->
<!--   mutate(TELECOMMUNICATIONS = (`TELECOMMUNICATIONS`/`COMP_TOT`)/(sum(SP_inner_join$COMP_A)/max(SP_inner_join$COMP_TOT))) %>% -->
...
Using the overall dataframe with non-aggregated industry, we will plot a choropleth map of 2017 universal healthcare population programme population. 

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
tm_shape(st_as_sf(eastkalimantan.podes))+
...
Let us create the boxmap function to use it to better visualise the variables.
```{r}
...
boxmap <- function(vnam,df,titlesize,legx, legy, legtitle=NA,mtitle="Box Map",mult=1.5){  
  ...
  tm_layout(main.title = paste("Box Map of ",toString(vnam)," Numbers by Desa"),
...
bm_qtm <- function(vnam,df,titlesize,legx, legy) {
  tm <- qtm(df, vnam, main.title = paste("Chloropleth of ",toString(vnam)," Numbers by Desa"), frame = FALSE, main.title.size = titlesize, main.title.position = "center")
...
```{r}
#example
boxmap("INFRA_DEVELOPMENT_SCORE", ekps.transformed, 0.5,0.5,0.5)
```

## Box plot for continuous variables

```{r}
bp <- ggplot(eastkalimantan.podes, aes(x = CITY, y = STATEMENT_OF_POVERTY, colour = CITY)) +
  geom_boxplot(fill = NA, alpha = 0.5) +
  #coord_flip()+
  scale_y_log10()+
  theme(legend.position="none")+
  geom_jitter(aes(text=paste("VILLAGE: ", VILLAGE)))+
  labs(title = "Population under poverty",
       y = "Population")
...
```{r}
bc <- ggplot(eastkalimantan.podes, aes(x = PRESENCE_VILLAGE_HEAD, fill = CITY)) +
  geom_bar(alpha = 0.8, position="stack") + 
  #theme(legend.position="none")+
  #geom_jitter(aes(y = VILLAGE_LOCATION_TO_FOREST, text=paste("VILLAGE: ", VILLAGE), width = 0.25))+
  #coord_flip() +
  #geom_point(aes(y = VILLAGE_LOCATION_TO_FOREST, colour = CITY), alpha = 0.8) +
  labs(title = "Presence of Village Head",
       y = "Count")
...
```{r}
ekps.cor <- cor(as.data.frame(ekps.transformed[7:45] %>% st_set_geometry(NULL)))
...
```{r}
ekps.corr.filtered <- corr_filter(as.data.frame(ekps.transformed[7:45] %>% st_set_geometry(NULL)), 0.7)
...
Adapted the code from this [source](https://uc-r.github.io/hc_clustering)
...
```{r}
plot(hclust_ward, cex = 0.1)#can try to drop labels
```
...
```{r}
cut_ward <- cutree(hclust_ward, k = 7)
```
...
```{r}
seeds_df_cl <- mutate(cluster_df, cluster = cut_ward)
count(seeds_df_cl,cluster)
```

Total amount of observation is 384 

```{r}
table(cut_ward, cluster_df$NUM_LEATHER_INDUSTRY)
```
...
From the above, we can see that the spatial distribution of the generated hierarchical clusters is rather fragmented. This does not make sense in the context of this project as urban planners likely would want a continuous plot of land to develop the new capital. Thus, we will be using the spatially constrained method moving forward. 


### 5.1.9 Finding the distribution of each variable of choice on each clusters 


```{r}
colnames(ekps.transformed)
```

Since there are 39 variables, we will plot all 39 of them in 3 separate plots with 13 variables each. 

```{r}
slum <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`PRESENCE_SLUMS`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

slash_burn <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`SLASH_AND_BURN`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

malnourished_pop <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`MALNOURISHED_POP`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

poverty_pop <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`POVERTY_POP`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

transport_methods <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`TRANSPORTATION_METHODS`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

road_access_4_wheel <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`ROAD_ACCESSIBLE_BY_4_WHEEL_VEHICLE`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

public_transport <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`PUBLIC_TRANSPORT`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

leather_indus <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`NUM_LEATHER_INDUSTRY`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

wood_indus <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`NUM_WOOD_INDUSTRY`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

metal_indus <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`NUM_METAL_INDUSTRY`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

fabric_indus <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`NUM_FABRIC_INDUSTRY`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

pottery_indus <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`NUM_POTTERY_INDUSTRY`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

bamboorattan_indus <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`NUM_BAMBOORATTAN_INDUSTRY`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

food_indus <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`NUM_FOOD_INDUSTRY`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

electricity <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`ELECTRICTY`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

water_disposal <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`WASTE_DISPOSAL`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

water_mgmt <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`WATER_MANAGEMENT`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")
        
natural_disaster_score <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`NATURAL_DISASTER_SCORE`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

healthcare_service <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`HEALTHCARE_SERVICE_NUM`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

healthcare_access_score <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`HEALTHCARE_ACCESS_SCORE`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

disease_outbreak_score <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`DISEASE_OUTBREAK_SCORE`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean")                
           
edu_institution_num <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`EDUCATION_INSTITUTION_NUM`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

edu_access_score <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`EDUCATION_ACCESS_SCORE`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

mail_access_score <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`MAIL_ACCESS_SCORE`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

industries <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`INDUSTRIES`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

cooperatives <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`COOPERATIVES`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

groceries_num <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`GROCERIES_NUMBER`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

groceries_access_Score <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`GROCERIES_ACCESS_SCORE`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

food_estab_num <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`FOOD_ESTAB_NUMBER`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

food_estab_access_score <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`FOOD_ESTAB_ACCESS_SCORE`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

lodging_num <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`LODGING_NUM`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

lodging_access_score <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`LODGING_ACCESS_SCORE`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

took_credit_score <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`TOOK_CREDIT_SCORE`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

bank_num <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`BANK_NUM`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

bank_access_score <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`BANK_ACCESS_SCORE`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

fi_infra_num <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`FI_INFRA_NUM`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

fi_infra_access_Score <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`FI_INFRA_ACCESS_SCORE`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

infra_dev_score <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`INFRA_DEVELOPMENT_SCORE`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

telecom <- ggplot(ekps.transformed, aes(x = `H_CLUSTER` , y=`TELECOMMUNICATIONS`, fill=`H_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

```

Since there are 39 variables, we will plot all 39 of them in 6 separate plots with 6 variables each plus 1 plot with 3 variables.


```{r}
ggarrange(slum, slash_burn, malnourished_pop, poverty_pop, transport_methods, road_access_4_wheel, nrow = 2, ncol =3)
```

```{r}
ggarrange(public_transport, leather_indus, wood_indus, metal_indus, fabric_indus, pottery_indus, nrow = 2, ncol =3)
```

```{r}
ggarrange(bamboorattan_indus, food_indus, electricity, water_disposal, water_mgmt, natural_disaster_score, nrow = 2, ncol =3)
```

```{r}
ggarrange(healthcare_service, healthcare_access_score, disease_outbreak_score, edu_institution_num, edu_access_score, mail_access_score, nrow = 2, ncol =3)
```

```{r}
ggarrange(industries, cooperatives, groceries_num, groceries_access_Score, food_estab_num, food_estab_access_score,  nrow = 2, ncol =3)
```

```{r}
ggarrange(lodging_num, lodging_access_score, took_credit_score, bank_num, bank_access_score, fi_infra_num, nrow = 2, ncol =3)
```

```{r}
ggarrange(fi_infra_access_Score, infra_dev_score, telecom, nrow = 3, ncol = 1)
```



## 5.2 Spatially Constrained Clustering - All Variables

Next, let us try the spatially constrained clustering method. This approach is likely to be more appropriate in this case as the urban planners likely do not want a collection of fragmented land for the new capital. 

### 5.2.1 Convert to SpatialPolygonsDataFrame

```{r}
ekps.transformed.sp <- as_Spatial(st_zm(ekps.transformed)) #st_zm needed since GIS data is in multipolygons
```

Change CRS to EPSG:2933 (Source)[https://epsg.io/2933]

```{r}
ekps.transformed.sp <- spTransform(ekps.transformed.sp, CRS("+init=epsg:2933"))
```

### 5.2.2 Compute Neighbours List

```{r}
ekps.nb <- poly2nb(ekps.transformed.sp)
summary(ekps.nb)
```

From the above, it seems that there is one desa that is not connected to any of the other desas. We need to keep this in mind when doing the spatially constrained clustering method. 

### 5.2.3 Resolve Desa that is unconnected

First, let us find out which Desa is disconnected.
...
The island desa's index is 30 in ekps.nb.

Next, we join it to the Desa that is the nearest to it

```{r}
nearest <- knearneigh(coordinates(ekps.transformed.sp))$nn
...
Visualize Final Neighbours List

```{r}
plot(ekps.transformed.sp, border=grey(.5))
plot(ekps.nb, coordinates(ekps.transformed.sp), col="blue", add=TRUE)
```

### 5.2.4 Compute Minimum Spanning Tree

```{r}
lcosts <- nbcosts(ekps.nb, cluster_df)
ekps.w <- nb2listw(ekps.nb, lcosts, style="B")
summary(ekps.w)
```
...
383 Edges present, which is equals to 384 (# of Desas) - 1. 

Visualise MST

```{r}
plot(ekps.transformed.sp, border=gray(.5))
plot.mst(ekps.mst, coordinates(ekps.transformed.sp), 
     col="blue", cex.lab=0.3, cex.circles=0.005, add=TRUE)
```

### 5.2.5 Compute Spatially Constrained Clusters using SKATER Approach

```{r}
clust6 <- skater(ekps.mst[,1:2], cluster_df, method = "euclidean", 6)
```
...
Looks relatively evenly spread, with the exception of Cluster 2. 

Visualise Clusters on MST

```{r}
plot(ekps.transformed.sp, border=gray(.5))
plot(clust6, coordinates(ekps.transformed.sp), cex.lab=.4,
     groups.colors=c("red","green","blue","yellow", "orange", "black", "grey"), cex.circles=0.005, add=TRUE)
```

##### compare the spatially constrained vs non-constrained and compare the mean 

Find out the characteristics of each  clusters in each method (barchart)


The discrepancy in the size of desas makes the above plot hard to visualise. Let us use a chloropleth to do it.

### 5.2.6 Visualise Spatially Constrained Clusters using Chloropleth Map

```{r}
groups_mat <- as.matrix(clust6$groups)
ekps.transformed <- cbind(ekps.transformed, as.factor(groups_mat)) %>%
  rename(`SP_CLUSTER`=`as.factor.groups_mat.`)
qtm(ekps.transformed, "SP_CLUSTER")
```
...
hclust_map<- tm_shape(ekps.transformed) + 
  tm_fill(col = "H_CLUSTER", id = "DESA") +
  tm_borders(alpha = 0.5)

hclust_map

# tmap_arrange(hclust_map, spclust_map, asp=NA, ncol=2)
```


```{r}
spclust_map <- tm_shape(ekps.transformed) + 
  tm_fill(col = "SP_CLUSTER", id = "DESA") +
  tm_borders(alpha = 0.5) +
  tm_scale_bar(width = 0.15)
...
tmap_mode("plot")
```
>>>>>>> f6834c6fbb0e0f8a5c5a4dd8849f62591287bdbf

```{r}
slum_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`PRESENCE_SLUMS`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

slash_burn_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`SLASH_AND_BURN`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

malnourished_pop_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`MALNOURISHED_POP`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

poverty_pop_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`POVERTY_POP`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

transport_methods_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`TRANSPORTATION_METHODS`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

road_access_4_wheel_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`ROAD_ACCESSIBLE_BY_4_WHEEL_VEHICLE`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

public_transport_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`PUBLIC_TRANSPORT`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

leather_indus_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`NUM_LEATHER_INDUSTRY`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

wood_indus_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`NUM_WOOD_INDUSTRY`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

metal_indus_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`NUM_METAL_INDUSTRY`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

fabric_indus_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`NUM_FABRIC_INDUSTRY`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

pottery_indus_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`NUM_POTTERY_INDUSTRY`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

bamboorattan_indus_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`NUM_BAMBOORATTAN_INDUSTRY`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

food_indus_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`NUM_FOOD_INDUSTRY`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

electricity_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`ELECTRICTY`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

water_disposal_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`WASTE_DISPOSAL`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

water_mgmt_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`WATER_MANAGEMENT`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")
        
natural_disaster_score_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`NATURAL_DISASTER_SCORE`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

healthcare_service_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`HEALTHCARE_SERVICE_NUM`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

healthcare_access_score_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`HEALTHCARE_ACCESS_SCORE`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")

disease_outbreak_score_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`DISEASE_OUTBREAK_SCORE`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean")                
           
edu_institution_num_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`EDUCATION_INSTITUTION_NUM`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

edu_access_score_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`EDUCATION_ACCESS_SCORE`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

mail_access_score_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`MAIL_ACCESS_SCORE`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

industries_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`INDUSTRIES`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

cooperatives_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`COOPERATIVES`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

groceries_num_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`GROCERIES_NUMBER`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

groceries_access_Score_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`GROCERIES_ACCESS_SCORE`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

food_estab_num_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`FOOD_ESTAB_NUMBER`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

food_estab_access_score_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`FOOD_ESTAB_ACCESS_SCORE`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

lodging_num_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`LODGING_NUM`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

lodging_access_score_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`LODGING_ACCESS_SCORE`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

took_credit_score_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`TOOK_CREDIT_SCORE`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

bank_num_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`BANK_NUM`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

bank_access_score_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`BANK_ACCESS_SCORE`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

fi_infra_num_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`FI_INFRA_NUM`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

fi_infra_access_Score_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`FI_INFRA_ACCESS_SCORE`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

infra_dev_score_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`INFRA_DEVELOPMENT_SCORE`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 

telecom_SP <- ggplot(ekps.transformed, aes(x = `SP_CLUSTER` , y=`TELECOMMUNICATIONS`, fill=`SP_CLUSTER`)) + geom_bar(stat="summary", fun="mean") 
...
```{r}
ggarrange(slum_SP, slash_burn_SP, malnourished_pop_SP, poverty_pop_SP, transport_methods_SP, road_access_4_wheel_SP, nrow = 2, ncol =3)
```

```{r}
ggarrange(public_transport_SP, leather_indus_SP, wood_indus_SP, metal_indus_SP, fabric_indus_SP, pottery_indus_SP, nrow = 2, ncol =3)
```

```{r}
ggarrange(bamboorattan_indus_SP, food_indus_SP, electricity_SP, water_disposal_SP, water_mgmt_SP, natural_disaster_score_SP, nrow = 2, ncol =3)
```

```{r}
ggarrange(healthcare_service_SP, healthcare_access_score_SP, disease_outbreak_score_SP, edu_institution_num_SP, edu_access_score_SP, mail_access_score_SP, nrow = 2, ncol =3)
```

```{r}
ggarrange(industries_SP, cooperatives_SP, groceries_num_SP, groceries_access_Score_SP, food_estab_num_SP, food_estab_access_score_SP,  nrow = 2, ncol =3)
```

```{r}
ggarrange(lodging_num_SP, lodging_access_score_SP, took_credit_score_SP, bank_num_SP, bank_access_score_SP, fi_infra_num_SP, nrow = 2, ncol =3)
```

```{r}
ggarrange(fi_infra_access_Score_SP, infra_dev_score_SP, telecom_SP, nrow = 3, ncol = 1)
```

##### Cluster 3 analysis

From the above spatially constrained clustering results, we can see that in most of the bar chart plotted above, cluster 3 stands out the most as either having the highest or lowest counts (mean). This prompted us to look into each the variable further. 

cluster 3 - tmap using the desa, make it interactive, make it static for the report. Bar chart to deliberate on the research paper


The code chunk below entails the population poverty level and malnourishment level

```{r}
ggarrange(malnourished_pop_SP,
poverty_pop_SP, nrow = 1, ncol =2)
```

The code chunk below entails the manufacturing/small industries

```{r}
ggarrange(leather_indus_SP,
metal_indus_SP,
fabric_indus_SP,
pottery_indus_SP,
food_indus_SP, nrow = 2, ncol =3)
```

The code chunk below entails the number of industries and cooperatives

```{r}
ggarrange(industries_SP,
cooperatives_SP, nrow = 1, ncol =2)
```


The code chunk below entails the number of public service available in cluster 3 

```{r}
ggarrange(electricity_SP,
water_disposal_SP,
healthcare_service_SP,
healthcare_access_score_SP,
edu_institution_num_SP,
edu_access_score_SP,
nrow = 2, ncol =3)
```

```{r}
ggarrange(mail_access_score_SP,
food_estab_num_SP,
food_estab_access_score_SP,
nrow = 2, ncol =2)
```

The code chunk below entails the number of banks/financial institution in cluster 3

```{r}
ggarrange(bank_num_SP,
bank_access_score_SP,
fi_infra_num_SP,
nrow = 2, ncol =2)
```

The code chunk below entails the public infrastructure for citizens in cluster 3 

```{r}
ggarrange(infra_dev_score_SP,
telecom_SP,
nrow = 1, ncol =2)
...
```{r}
ggarrange(bank_num_SP, bank_access_score_SP,
fi_infra_num_SP,
healthcare_service_SP,
nrow = 2, ncol =2)
```
...
# 6 Spatially Constrained Clustering (SKATER) - Overall

This section details the spatially constrained method by different sectors/variable groups. 

First, let us create functions in order to reduce the amount of repeated code that is written.

This function takes in the original transformed df and the specific columns we want that are in a vector format. It resets the index of the dataframe and normalises it. Furthermore, the gap statistic is calculated to pick out the optimum cluster number for the spatially constrained clustering. 

```{r}
prep_cluster_df <- function(org_df, vector_cols) {
  cluster_df <- org_df %>%
  st_set_geometry(NULL) %>%
  select(all_of(
    vector_cols)
  ...
  row.names(cluster_df) <- cluster_df$DESA
  cluster_df <- cluster_df[,-1] # drop the DESA column since it is now the index
  
  #Normalize df
  cluster_df <- normalize(cluster_df)
    
  # Select clust_num using gap statistic
  set.seed(12345)
  gap_stat <- clusGap(cluster_df, FUN = hcut, nstart = 20, K.max =15, B =50)
  ...
  # Visualize statistic in a plot for selection of optimal clusters
...
This function performs the spatially contrained method using the previously constructed neighbour weights and the optimum number of clusters. It also takes in a col_name argument which will be used to rename the generated column for the sector spatially constrained method. 

```{r}
sc_clust <- function(nb_mat, cluster_df, clust_num) {
  # Generate Weights
  lcosts <- nbcosts(nb_mat, cluster_df)
  ekps.w <- nb2listw(nb_mat, lcosts, style="B")
  summary(ekps.w)
  
  # Compute MST
  ekps.mst <- mstree(ekps.w)
  dim(ekps.mst) # check if the mst has the correct number of edges
  ...
  # Use Skater Method to create spatially constrained clusters
  clust <- skater(ekps.mst[,1:2], cluster_df, method = "euclidean", clust_num-1)
  groups_mat <- as.matrix(clust$groups)
  
  
  ekps.transformed <- cbind(ekps.transformed, as.factor(groups_mat)) 
  return(ekps.transformed)
}
```

Now, let us split all the variables we have into several sectors for profiling. 

```{r}
healthcare <- c("DESA", "HEALTHCARE_SERVICE_NUM", "DISEASE_OUTBREAK_SCORE","MALNOURISHED_POP", "HEALTHCARE_ACCESS_SCORE")

industrial <- c("DESA", "NUM_LEATHER_INDUSTRY", "NUM_WOOD_INDUSTRY", "NUM_METAL_INDUSTRY", "NUM_FABRIC_INDUSTRY", "NUM_POTTERY_INDUSTRY", "NUM_BAMBOORATTAN_INDUSTRY", "NUM_FOOD_INDUSTRY", "INDUSTRIES", "COOPERATIVES")

financial <- c("DESA", "BANK_NUM", "BANK_ACCESS_SCORE", "FI_INFRA_ACCESS_SCORE", "FI_INFRA_NUM", "TOOK_CREDIT_SCORE", "POVERTY_POP")

transport <- c("DESA", "TRANSPORTATION_METHODS","ROAD_ACCESSIBLE_BY_4_WHEEL_VEHICLE", "PUBLIC_TRANSPORT")

food <- c("DESA", "GROCERIES_ACCESS_SCORE" , "GROCERIES_NUMBER", "FOOD_ESTAB_NUMBER", "FOOD_ESTAB_ACCESS_SCORE")

development <- c("DESA", "PRESENCE_SLUMS", "INFRA_DEVELOPMENT_SCORE", "ELECTRICTY", "WASTE_DISPOSAL", "WATER_MANAGEMENT")

disasters <- c("DESA", "PRESENCE_MUDSLIDES", "PRESENCE_FLOOD", "PRESENCE_FLASHFLOOD" , "PRESENCE_EARTHQUAKE", "PRESENCE_TSUNAMI", "PRESENCE_TIDALWAVES", "PRESENCE_TORNADO", "PRESENCE_VOLCANIC_ERUPTIONS", "PRESENCE_FORESTFIRE" , "WARNING_SYSTEM_NATURAL_DISASTER" ,"WARNING_SYSTEM_TSUNAMI") #use non aggregated variable as using only 1 clustering variable NATURAL_DISASTER_SCORE does not make sense

communication <- c("DESA","MAIL_ACCESS_SCORE", "TELECOMMUNICATIONS")

education <- c("DESA", "EDUCATION_INSTITUTION_NUM", "EDUCATION_ACCESS_SCORE")
```

```{r}
load(file = "district_border.Rda")
load(file = "city_border.Rda")
```



## 6.1 Spatially Constrained Clustering (SKATER) - Profiling Healthcare Sector

Select optimal number of clusters

```{r}
healthcare_cluster_df <- prep_cluster_df(ekps.transformed, healthcare)
```
From the above, we pick k=5 since the gradient from 4 to 5 is steep while the gradient from 5 to 6 is very gentle. 

```{r}
ekps.transformed <- sc_clust(ekps.nb, healthcare_cluster_df, 5)
```

Lastly, we rename the column and plot the cluster number on a qtm.
s
```{r}
<<<<<<< HEAD
#ekps.transformed <- ekps.transformed %>% rename(`HEALTHCARE_SC_CLUSTER` = `as.factor.groups_mat.`)

tmap_mode("plot")
tm_shape(ekps.transformed) + 
  tm_fill(col = "HEALTHCARE_SC_CLUSTER") +
  tm_borders(alpha = 0.5) +
  tm_scale_bar(width = 0.15)
...
ekps.transformed <- ekps.transformed %>% rename(`HEALTHCARE_SC_CLUSTER` = `as.factor.groups_mat.`)
qtm(ekps.transformed, "HEALTHCARE_SC_CLUSTER")
>>>>>>> f6834c6fbb0e0f8a5c5a4dd8849f62591287bdbf
```
...
## 6.2 Spatially Constrained Clustering (SKATER) - Profiling Industrial Sector

Select optimal number of clusters

```{r}
industrial_cluster_df <- prep_cluster_df(ekps.transformed, industrial)
```

From the above, we pick k=4 since the gradient from 3 to 4 is steep while the gradient from 4 to 5 is very gentle. 

```{r}
ekps.transformed <- sc_clust(ekps.nb, industrial_cluster_df, 4)
```

Lastly, we rename the column and plot the cluster number on a qtm.

```{r}
ekps.transformed <- ekps.transformed %>% rename(`INDUSTRIAL_SC_CLUSTER` = `as.factor.groups_mat.`)


tmap_mode("view")

tm_shape(ekps.transformed) + 
  tm_fill(col = "INDUSTRIAL_SC_CLUSTER") +
  tm_borders(alpha = 0.5) +
  tm_scale_bar(width = 0.15)
...
## 6.3 Spatially Constrained Clustering (SKATER) - Profiling Financial Sector

Select optimal number of clusters

```{r}
financial_cluster_df <- prep_cluster_df(ekps.transformed, financial)
```

From the above, we pick k=8 since the gradient from 7 to 8 is steep while the gradient from 8 to 9 is gentler. 

```{r}
ekps.transformed <- sc_clust(ekps.nb, financial_cluster_df, 8)
```

Lastly, we rename the column and plot the cluster number on a qtm.

```{r}
#ekps.transformed <- ekps.transformed %>% rename(`FINANCIAL_SC_CLUSTER` = `as.factor.groups_mat.`)

tmap_mode("plot")

tm_shape(ekps.transformed) + 
  tm_fill(col = "FINANCIAL_SC_CLUSTER") +
  tm_borders(alpha = 0.5) +
  tm_scale_bar(width = 0.15)
...
## 6.4 Spatially Constrained Clustering (SKATER) - Profiling Transport Sector

Select optimal number of clusters

```{r}
transport_cluster_df <- prep_cluster_df(ekps.transformed, transport)
```

From the above, we pick k=6 since the gradient from 5 to 6 is steep while the gradient from 6 to 7 is gentler. 

```{r}
ekps.transformed <- sc_clust(ekps.nb, transport_cluster_df, 6)
```

Lastly, we rename the column and plot the cluster number on a qtm.

```{r}
ekps.transformed <- ekps.transformed %>% rename(`TRANSPORT_SC_CLUSTER` = `as.factor.groups_mat.`)
...
tm_shape(ekps.transformed) + 
  tm_fill(col = "TRANSPORT_SC_CLUSTER") +
  tm_borders(alpha = 0.5) +
  tm_scale_bar(width = 0.15)
```

## 6.5 Spatially Constrained Clustering (SKATER) - Profiling Food Sector

Select optimal number of clusters

```{r}
food_cluster_df <- prep_cluster_df(ekps.transformed, food)
```

From the above, we pick k=6 since the gradient from 6 to 7 had a drop. 

```{r}
ekps.transformed <- sc_clust(ekps.nb, food_cluster_df,6 )
```

Lastly, we rename the column and plot the cluster number on a qtm.

```{r}
ekps.transformed <- ekps.transformed %>% rename(`FOOD_SC_CLUSTER` = `as.factor.groups_mat.`)
...
tm_shape(ekps.transformed) + 
  tm_fill(col = "FOOD_SC_CLUSTER") +
  tm_borders(alpha = 0.5) +
  tm_scale_bar(width = 0.15)
```

## 6.6 Spatially Constrained Clustering (SKATER) - Profiling Development

Select optimal number of clusters

```{r}
development_cluster_df <- prep_cluster_df(ekps.transformed, development)
```

From the above, we pick k=6 since the gradient from 5 to 6 is steep while the gradient from 6 to 7 is gentler. 

```{r}
ekps.transformed <- sc_clust(ekps.nb, development_cluster_df, 6)
```

Lastly, we rename the column and plot the cluster number on a qtm.

```{r}
ekps.transformed <- ekps.transformed %>% rename(`DEVELOPMENT_SC_CLUSTER` = `as.factor.groups_mat.`)

tmap_mode("view")

tm_shape(ekps.transformed) + 
  tm_fill(col = "DEVELOPMENT_SC_CLUSTER") +
  tm_borders(alpha = 0.5) +
  tm_scale_bar(width = 0.15)
```


## 6.7 Spatially Constrained Clustering (SKATER) - Profiling Disasters

Initial running of clustering algorithm resulted in errors. Diagnose why error occurs.

```{r}
diag <- ekps.recoded %>% st_set_geometry(NULL) %>% select(all_of(disasters))
normalize(diag)
```

We cam see that **PRESENCE_EARTHQUAKE**, **PRESENCE_TSUNAMI** and **PRESENCE_VOLCANIC_ERUPTIONS** have NaN values. This means that before scaling, they were probably the same value throughout all 384 desas. Remove these variables. 

```{r}
remove <- c("PRESENCE_EARTHQUAKE", "PRESENCE_TSUNAMI", "PRESENCE_VOLCANIC_ERUPTIONS")
disasters <- setdiff(disasters, remove)
```

With that out of the way, let us continue running the algorithm.

Select optimal number of clusters

```{r}
disaster_cluster_df <- prep_cluster_df(ekps.recoded, disasters)
```

From the above, we pick k=5 since the gradient from 4 to 5 is steeper than the gradient from 5 to 6.

```{r}
ekps.transformed <- sc_clust(ekps.nb, disaster_cluster_df, 5)
```

Lastly, we rename the column and plot the cluster number on a qtm.

```{r}
ekps.transformed <- ekps.transformed %>% rename(`DISASTER_SC_CLUSTER` = `as.factor.groups_mat.`)
...
tm_shape(ekps.transformed) + 
  tm_fill(col = "DISASTER_SC_CLUSTER") +
  tm_borders(alpha = 0.5) +
  tm_scale_bar(width = 0.15)
```

## 6.8 Spatially Constrained Clustering (SKATER) - Profiling Telecommunication Sector

Select optimal number of clusters

```{r}
telecomm_cluster_df <- prep_cluster_df(ekps.transformed, communication)
```

From the above, we pick k=3 since the gap statistic drops when k is increased to 4.

```{r}
ekps.transformed <- sc_clust(ekps.nb, telecomm_cluster_df, 3)
```

Lastly, we rename the column and plot the cluster number on a qtm.

```{r}
ekps.transformed <- ekps.transformed %>% rename(`TELECOMM_SC_CLUSTER` = `as.factor.groups_mat.`)

tmap_mode("view")

tm_shape(ekps.transformed) + 
  tm_fill(col = "TELECOMM_SC_CLUSTER") +
  tm_borders(alpha = 0.5) +
  tm_scale_bar(width = 0.15)
```

## 6.9 Spatially Constrained Clustering (SKATER) - Profiling Education Sector

Select optimal number of clusters

```{r}
edu_cluster_df <- prep_cluster_df(ekps.transformed, education)
```

From the above, we pick k=2 since the gap statistic drops when k is increased to 3.

```{r}
ekps.transformed <- sc_clust(ekps.nb, edu_cluster_df,2 )
```
...
```{r}
ekps.transformed <- ekps.transformed %>% rename(`EDUCATION_SC_CLUSTER` = `as.factor.groups_mat.`)

tmap_mode("plot")

tm_shape(ekps.transformed) + 
  tm_fill(col = "EDUCATION_SC_CLUSTER") +
  tm_borders(alpha = 0.5) +
  tm_scale_bar(width = 0.15)
```


# 7 Spatially Constrained Clustering (ClustGeo) - Overall

First, let us derive the inputs required for the ClustGeo functions.

```{r}
# Data matrix 
# dat <- ekps.transformed[6:45] %>% st_set_geometry(NULL)
dat <- ekps.transformed %>%
  st_set_geometry(NULL) %>%
  select("DESA",
         "PRESENCE_SLUMS",
         "SLASH_AND_BURN",
...
row.names(dat) <- dat$DESA
dat <- dat[,-1] # drop the DESA column since it is now the index
dat <- normalize(dat)

# Distance matrix
dist <- dist(dat)

# Map of class SpatialPolygonsDataFrame
map <- ekps.transformed.sp 
```

## 7.1 Spatially Constrained Clustering (ClustGeo) taking into account input variables only - Overall
...
### 7.1.1 Visualise Clusters on Map

```{r}
# plot(map, border = "grey")
P7 <- cutree(tree, 7)

ekps.transformed$cgd0 <- P7
qtm(ekps.transformed, "cgd0")
```

The clusters appear geographically very fragmented.We need to introduce the geographical distances between the desas into the clustering.

## 7.2 Spatially Constrained Clustering (ClustGeo)taking into account geographical distances - Overall

### 7.2.1 Derive Geographical Distance Matrix

```{r}
# Convert map to latlong projection instead of UTM
map_ll <- spTransform(map, CRS("+proj=longlat +datum=WGS84"))

# Extract coordinates of DESAs
coords <- coordinates(map_ll)
row.names(coords) <- map_ll$DESA
colnames(coords) <- c("lon", "lat")
D1 <- geodist(coords, measure = "vincenty") #use vincenty measure to reduce error as distance gets beyond 100km
# D1 <- D1/1000 # convert from m to km
D1 <- as.dist(D1)
```

### 7.2.2 Choose optimal mixing parameter, α

The alpha value determines the relative importance we assign to the clustering variables vs that of the geographical distances. The higher the alpha, the greater the geographical differences are factored into the clustering algorithm.
...
We see on the plot the proportion of explained pseudo inertia calculated with D0 (the distances related to the clustering variables) is equal to 0.508 when α=0 and decreases when α increases (black line) On the contrary the proportion of explained pseudo inertia calculated with D1 (the geographical distances) is equal to 0.89 when α=1 and decreases when α decreases (red line).

From the plot, it is suggested that we pick α= 0.4, as it results in a loss of  clustering (due to variables) homogenity of 10% while resulting in a gain of geographic homogenity of 20%. 

### 7.2.3 Modified partiton with alpha = 0.4

```{r}
tree_d1 <- hclustgeo(D0,D1, alpha=0.4)
P7d1 <- cutree(tree,7)
```

### 7.2.4 Visualise new clusters

```{r}
tmap_mode("plot")
ekps.transformed$cgd1 <- P7d1
qtm(ekps.transformed, "cgd1")
```


## 7.3 Spatially Constrained Clustering (ClustGeo) taking into account neighbours - Overall

```{r}
A <- nb2mat(ekps.nb, style = "B")
diag(A) <- 1
colnames(A) <- rownames(A) <- map$DESA
A[1:3,1:3]
```
...
```{r}
cr <- choicealpha(D0, D1_n, range.alpha, K, graph = TRUE)
```
...
We see on the plot the proportion of explained pseudo inertia calculated with D0 (the distances related to the clustering variables) is equal to 0.508 when α=0 and decreases when α increases (black line) On the contrary the proportion of explained pseudo inertia calculated with D1 (the geographical distances) is equal to 0.0916 when α=1 and decreases when α decreases (red line).

```{r}
print(cr$Qnorm)
```

We pick alpha = 0.2 since it results in a loss of  clustering (due to variables) homogenity of 8% while resulting in a gain of geographic homogenity of 18%.

```{r}
tree <- hclustgeo(D0,D1_n,alpha=0.2)
P7ter <- cutree(tree,7)

ekps.transformed$cgdn <- P7ter
qtm(ekps.transformed, "cgdn")
```

## 7,4 Spatially Constrained Clustering (ClustGeo) - By Sector 

Now, we will extend the analysis to the sectors created in the previous section for the SKATER method. Similarly, we will write the ClustGeo clustering functions into appropriate functions to reduce the amount of repeated code written.The cluster numbers used for analysis in tis portion will follow that used for the SKATER method, which is chosen by looking at the GapStatistic. 

This function gives us the D0 matrix, which computes the euclidean distance between the various DESAs based on input

```{r}
getD0 <- function(org_df, vector_vars) {
  dat <- org_df %>%
  st_set_geometry(NULL) %>%
...
This function plots the Qnorm for D0 and D1 as alpha varies from 0 to 1. This is used to select the best alpha for the ClustGeo
...
This function performs the clustering required and appends the clusters to the ekps.transformed df
...
geoclustering <- function(D0, D1, alpha, K) {
  ...
  ekps.transformed <- cbind(ekps.transformed, as.factor(clust)) 
  return(ekps.transformed)
}
```


### 7.4.1 Profiling Healthcare Sector

Get D0 Matrix

```{r}
D0_healthcare <- getD0(ekps.transformed, healthcare)
```

#### 7.4.1.1 Spatially Constrained Clustering (ClustGeo) taking into account geographical distances

```{r}
alpha_geo(D0_healthcare, D1, 5)
```

Pick alpha = 0.25 since it results in a loss of  clustering (due to variables) homogenity of 5% while resulting in a gain of geographic homogenity of 24%.

```{r}
ekps.transformed <- geoclustering(D0_healthcare, D1, 0.25, 5)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`HEALTHCARE_CG_DIST_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "HEALTHCARE_CG_DIST_CLUSTER")
```

#### 7.4.1.2 Spatially Constrained Clustering (ClustGeo) taking into account neighbours

```{r}
alpha_geo(D0_healthcare, D1_n, 5)
```

Pick alpha = 0.2 since it results in a loss of  clustering (due to variables) homogenity of 9% while resulting in a gain of geographic homogenity of 15%.

```{r}
ekps.transformed <- geoclustering(D0_healthcare, D1_n, 0.2, 5)
```

Rename Column holding clustering number

```{r}
ekps.transformed <- ekps.transformed %>% rename(`HEALTHCARE_CG_NEIGH_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "HEALTHCARE_CG_NEIGH_CLUSTER")
```

### 7.4.2 Profiling Industrial Sector

Get D0 Matrix

```{r}
D0_industrial <- getD0(ekps.transformed, industrial)
```

#### 7.4.2.1 Spatially Constrained Clustering (ClustGeo) taking into account geographical distances

```{r}
alpha_geo(D0_industrial, D1,4)
```

Pick alpha = 0.1 since it results in a loss of  clustering (due to variables) homogenity of 17% while resulting in a gain of geographic homogenity of 41%.

```{r}
ekps.transformed <- geoclustering(D0_industrial, D1, 0.1, 4)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`INDUSTRIAL_CG_DIST_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "INDUSTRIAL_CG_DIST_CLUSTER")
```

#### 7.4.2.2 Spatially Constrained Clustering (ClustGeo) taking into account neighbours

```{r}
alpha_geo(D0_industrial, D1_n, 4)
```

Pick alpha = 0.15 since it results in a loss of  clustering (due to variables) homogenity of 7% while resulting in a gain of geographic homogenity of 19%.

```{r}
ekps.transformed <- geoclustering(D0_industrial, D1_n, 0.15, 4)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`INDUSTRIAL_CG_NEIGH_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "INDUSTRIAL_CG_NEIGH_CLUSTER")
```

### 7.4.3 Profiling Financial Sector

Get D0 Matrix

```{r}
D0_financial <- getD0(ekps.transformed, financial)
```

#### 7.4.3.1 Spatially Constrained Clustering (ClustGeo) taking into account geographical distances

```{r}
alpha_geo(D0_financial, D1, 8)
```

Pick alpha = 0.3  since it results in a loss of  clustering (due to variables) homogenity of 7% while resulting in a gain of geographic homogenity of 21%.

```{r}
ekps.transformed <- geoclustering(D0_financial, D1, 0.3, 8)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`FINANCIAL_CG_DIST_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "FINANCIAL_CG_DIST_CLUSTER")
```

#### 7.4.3.2 Spatially Constrained Clustering (ClustGeo) taking into account neighbours

```{r}
alpha_geo(D0_financial, D1_n, 8)
```

Pick alpha = 0.1 since it results in a loss of  clustering (due to variables) homogenity of 7% while resulting in a gain of geographic homogenity of 19%.

```{r}
ekps.transformed <- geoclustering(D0_financial, D1_n, 0.1, 8)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`FINANCIAL_CG_NEIGH_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "FINANCIAL_CG_NEIGH_CLUSTER")
```

### 7.4.4 Profiling Transport Sector

Get D0 Matrix

```{r}
D0_transport<- getD0(ekps.transformed, transport)
```

#### 7.4.1.1 Spatially Constrained Clustering (ClustGeo) taking into account geographical distances

```{r}
alpha_geo(D0_transport, D1, 6)
```

Pick alpha = 0.6 since it results in a loss of  clustering (due to variables) homogenity of 9% while resulting in a gain of geographic homogenity of 24%.

```{r}
ekps.transformed <- geoclustering(D0_transport, D1, 0.6, 6)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`TRANSPORT_CG_DIST_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "TRANSPORT_CG_DIST_CLUSTER")
```

#### 7.4.1.2 Spatially Constrained Clustering (ClustGeo) taking into account neighbours

```{r}
alpha_geo(D0_transport, D1_n, 6)
```

Pick alpha = 0.35 since it results in a loss of  clustering (due to variables) homogenity of 3% while resulting in a gain of geographic homogenity of 6%.

```{r}
ekps.transformed <- geoclustering(D0_transport, D1_n, 0.35, 6)
```

Rename Column holding clustering number

```{r}
ekps.transformed <- ekps.transformed %>% rename(`TRANSPORT_CG_NEIGH_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "TRANSPORT_CG_NEIGH_CLUSTER")
```

### 7.4.5 Profiling Food Sector

Get D0 Matrix

```{r}
D0_food <- getD0(ekps.transformed, food)
```

#### 7.4.5.1 Spatially Constrained Clustering (ClustGeo) taking into account geographical distances

```{r}
alpha_geo(D0_food, D1, 6)
```

Pick alpha = 0.15 since it results in a loss of  clustering (due to variables) homogenity of 8% while resulting in a gain of geographic homogenity of 28%.

```{r}
ekps.transformed <- geoclustering(D0_food, D1, 0.15, 6)
```

Rename Column holding clustering number

```{r}
ekps.transformed <- ekps.transformed %>% rename(`FOOD_CG_DIST_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "FOOD_CG_DIST_CLUSTER")
```

#### 7.4.5.2 Spatially Constrained Clustering (ClustGeo) taking into account neighbours

```{r}
alpha_geo(D0_food, D1_n, 6)
```

Pick alpha = 0.15 since it results in a loss of  clustering (due to variables) homogenity of 9% while resulting in a gain of geographic homogenity of 14%.

```{r}
ekps.transformed <- geoclustering(D0_food, D1_n, 0.15, 6)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`FOOD_CG_NEIGH_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "FOOD_CG_NEIGH_CLUSTER")
```

### 7.4.6 Profiling Development Sector

Get D0 Matrix

```{r}
D0_development<- getD0(ekps.transformed, development)
```

#### 7.4.6.1 Spatially Constrained Clustering (ClustGeo) taking into account geographical distances

```{r}
alpha_geo(D0_development, D1, 6)
```

Pick alpha = 0.3 since it results in a loss of  clustering (due to variables) homogenity of 6% while resulting in a gain of geographic homogenity of 21%.

```{r}
ekps.transformed <- geoclustering(D0_development, D1, 0.3, 6)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`DEVELOPMENT_CG_DIST_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "DEVELOPMENT_CG_DIST_CLUSTER")
```

#### 7.4.6.2 Spatially Constrained Clustering (ClustGeo) taking into account neighbours

```{r}
alpha_geo(D0_development, D1_n, 6)
```

Pick alpha = 0.15 since it results in a loss of  clustering (due to variables) homogenity of 3% while resulting in a gain of geographic homogenity of 7%.

```{r}
ekps.transformed <- geoclustering(D0_development, D1_n, 0.15, 6)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`DEVELOPMENT_CG_NEIGH_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "DEVELOPMENT_CG_NEIGH_CLUSTER")
```

### 7.4.7 Profiling Disasters Sector

Get D0 Matrix

```{r}
D0_disasters <- getD0(ekps.recoded, disasters)
```

#### 7.4.7.1 Spatially Constrained Clustering (ClustGeo) taking into account geographical distances

```{r}
alpha_geo(D0_disasters, D1, 5)
```

Pick alpha = 0.5 since it results in a loss of  clustering (due to variables) homogenity of 16% while resulting in a gain of geographic homogenity of 24%.

```{r}
ekps.transformed <- geoclustering(D0_disasters, D1, 0.5, 5)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`DISASTER_CG_DIST_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "DISASTER_CG_DIST_CLUSTER")
```

#### 7.4.7.2 Spatially Constrained Clustering (ClustGeo) taking into account neighbours

```{r}
alpha_geo(D0_disasters, D1_n, 5)
```

Pick alpha = 0.15 since it results in a loss of  clustering (due to variables) homogenity of 2% while resulting in a gain of geographic homogenity of 5%.

```{r}
ekps.transformed <- geoclustering(D0_disasters, D1_n, 0.15, 5)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`DISASTER_CG_NEIGH_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "DISASTER_CG_NEIGH_CLUSTER")
```

### 7.4.8 Profiling Telecommunication Sector

Get D0 Matrix

```{r}
D0_comm <- getD0(ekps.transformed, communication)
```

#### 7.4.8.1 Spatially Constrained Clustering (ClustGeo) taking into account geographical distances

```{r}
alpha_geo(D0_comm, D1, 3)
```

Pick alpha = 0.35 since it results in a loss of  clustering (due to variables) homogenity of 16% while resulting in a gain of geographic homogenity of 42%.

```{r}
ekps.transformed <- geoclustering(D0_comm, D1, 0.35, 3)
```

Rename Column holding clustering number

```{r}
ekps.transformed <- ekps.transformed %>% rename(`TELECOMM_CG_DIST_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "TELECOMM_CG_DIST_CLUSTER")
```

#### 7.4.8.2 Spatially Constrained Clustering (ClustGeo) taking into account neighbours

```{r}
alpha_geo(D0_comm, D1_n, 3)
```

Pick alpha = 0.35 since it results in a loss of  clustering (due to variables) homogenity of 16% while resulting in a gain of geographic homogenity of 25%.

```{r}
ekps.transformed <- geoclustering(D0_comm, D1_n, 0.35, 3)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`TELECOMM_CG_NEIGH_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "TELECOMM_CG_NEIGH_CLUSTER")
```

### 7.4.9 Profiling Education Sector

Get D0 Matrix

```{r}
D0_edu <- getD0(ekps.transformed, education)
```

#### 7.4.9.1 Spatially Constrained Clustering (ClustGeo) taking into account geographical distances

```{r}
alpha_geo(D0_edu, D1, 2)
```

Pick alpha = 0.35 since it results in a loss of  clustering (due to variables) homogenity of 41% while resulting in a gain of geographic homogenity of 53%.

```{r}
ekps.transformed <- geoclustering(D0_edu, D1, 0.35, 2)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`EDUCATION_CG_DIST_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "EDUCATION_CG_DIST_CLUSTER")
```

#### 7.4.9.2 Spatially Constrained Clustering (ClustGeo) taking into account neighbours

```{r}
alpha_geo(D0_edu, D1_n, 2)
```

Pick alpha = 0.05 since it results in a loss of  clustering (due to variables) homogenity of 5% while resulting in a gain of geographic homogenity of 20%.

```{r}
ekps.transformed <- geoclustering(D0_edu, D1_n, 0.05, 2)
```

Rename Column holding clustering number 

```{r}
ekps.transformed <- ekps.transformed %>% rename(`EDUCATION_CG_NEIGH_CLUSTER` = `as.factor.clust.`)
qtm(ekps.transformed, "EDUCATION_CG_NEIGH_CLUSTER")
```
