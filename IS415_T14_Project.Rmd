...
# 6 Spatially Constrained Clustering by Sector
...
This function takes in the original transformed df and the specific columns we want that are in a vector format. It resets the index of the dataframe and normalises it. Furthermore, the gap statistic is calculated to pick out the optimum cluster number for the spatially contrained clustering. 
...
## 6.1 Spatially Constrained Clustering - Profiling Healthcare Sector
...
## 6.2 Spatially Constrained Clustering - Profiling Industrial Sector
Select optimal number of clusters
```{r}
...
## 6.3 Spatially Constrained Clustering - Profiling Financial Sector
Select optimal number of clusters
```{r}
...
## 6.4 Spatially Constrained Clustering - Profiling Transport Sector
...
## 6.5 Spatially Constrained Clustering - Profiling Food Sector
...
## 6.6 Spatially Constrained Clustering - Profiling Development
...
## 6.7 Spatially Constrained Clustering - Profiling Disasters
...
## 6.8 Spatially Constrained Clustering - Profiling Telecommunication Sector
...
## 6.9 Spatially Constrained Clustering - Profiling Education Sector
