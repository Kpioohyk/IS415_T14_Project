...
podes <- podes %>% 
  ...
  mutate(R1008EK3 = recode_factor(as.vector(podes$R1008EK3), `1` = 1, `2` = 0)) %>% 
  mutate(R1008FK3 = recode_factor(as.vector(podes$R1008FK3), `1` = 1, `2` = 0)) %>% 
  mutate(R1008GK3 = recode_factor(as.vector(podes$R1008GK3), `1` = 1, `2` = 0))
