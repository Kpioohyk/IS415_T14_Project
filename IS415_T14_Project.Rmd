...
packages = c('sf','spdep','rgdal','tmap','tidyverse', 'cluster', 'NbClust', 'heatmaply', 'corrplot','factoextra')
for (p in packages){
...
var_meaning3 = c("Shape", "R101", "R101N", "R102", "R102N", "R103", "R103N", "R104", "R104N",'HAS_ISLAM',
                   ...
                   'dummy1', #add in 7 dummy variable names for columns that we will not be keeping 
                   'dummy2',
                   'dummy3',
                   'dummy4',
                   'dummy5',
...
Join Podes3 to area to retrieve GIS Information
```{r}
colnames(podes3) <- var_meaning3
podes3$R101 <- as.character(podes3$R101) #change data type to allow for join
podes3.joined <- inner_join(area, podes3, by = c("PROVINCE_ID" = "R101",
                                                "CITY_ID" = "R102",
                                                "DISTRICT_ID" = "R103",
                                                "VILLAGE_ID" = "R104"))
```
...
```{r}
selected_podes3 <- c("Shape", "R101", "R101N", "R102", "R102N", "R103", "R103N", "R104", "R104N", "GEOMETRY",
                   'HAS_CULTURAL_RESERVE_SITES',
                   'HAS_COMMUNAL_SPACES',
                   'NUM_WOMEN_EDUCATION_ORGS',
                   'NUM_YOUTH_ORGS', #
...
Take out selected columns only 
```{r}
selected <- names(podes3.joined)[names(podes3.joined) %in% selected_podes3]
podes3.subset <- podes3.joined[,selected]
```
