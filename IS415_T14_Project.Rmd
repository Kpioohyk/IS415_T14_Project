...
qtm(ekps.transformed, "INDUSTRIAL_SC_CLUSTER")
...
qtm(ekps.transformed, "FINANCIAL_SC_CLUSTER")
```
...
qtm(ekps.transformed, "TRANSPORT_SC_CLUSTER")
```
...
qtm(ekps.transformed, "FOOD_SC_CLUSTER")
```
...
qtm(ekps.transformed, "DEVELOPMENT_SC_CLUSTER")
```
...
qtm(ekps.transformed, "DISASTER_SC_CLUSTER")
```
...
qtm(ekps.transformed, "TELECOMM_SC_CLUSTER")
```
...
qtm(ekps.transformed, "EDUCATION_SC_CLUSTER")
```
