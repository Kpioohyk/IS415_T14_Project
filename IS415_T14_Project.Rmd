...
### 3.5.4 PODES 2018 part 4 (security, finance and village assets, development and empowerment of village)
...
Variable R1301B ending with K2 refers to the total number of massive fighting incidents.

Variable R1301B ending with K3 refers to the presence of death casualty caused by such incidents. We will recode this to 1 for yes and 0 for no.

Variable R1301B1 - fighting incident between community groups

Variable R1301B2 - fighting incident between rural community groups

Variable R1301B3 - fighting incident between security forces

Variable R1301B4 - fighting incident between government officials

Variable R1301B5 - fighting incident between students

Variable R1301B6 - fighting incident between ethnic groups

Variable R1301B6 - fighting incident between other groups

Variable R1301B3, R1301B4 and R1301B6 will not be recoded because their data types are logical and all are NA values, we will not be recoding R1301B7 variables too because the massive fighting incident is not specified, hence not relevant.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1301B1K3 = recode_factor(as.vector(podes4$R1301B1K3), `1` = 1 , `2` = 0 )) %>%
  mutate(R1301B2K3 = recode_factor(as.vector(podes4$R1301B2K3), `1` = 1 , `2` = 0 )) %>%
  mutate(R1301B5K3 = recode_factor(as.vector(podes4$R1301B5K3), `1` = 1 , `2` = 0 ))
```

Variable R1301B ending with K4 refers to the presence of injury casualty caused by such incidents. We will recode this to 1 for yes and 0 for no.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1301B1K4 = recode_factor(as.vector(podes4$R1301B1K4), `1` = 1 , `2` = 0 )) %>%
  mutate(R1301B2K4 = recode_factor(as.vector(podes4$R1301B2K4), `1` = 1 , `2` = 0 )) %>%
  mutate(R1301B5K4 = recode_factor(as.vector(podes4$R1301B5K4), `1` = 1 , `2` = 0 ))
```


Variable R1301B ending with K5 refers to the cause of different types of massive fighting incident. These variables will be recoded from 1 to "PROPERTY", 2 for "POWER", 4 for "LOVE", 8 for "IDEOLOGY", 16 for "ENTERTAINMENT", 32 for "DISSATISFACTION" and 64 for "OTHERS".

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1301B1K5 = recode_factor(as.vector(podes4$R1301B1K5), `1` = "PROPERTY" , `2` = "POWER", `4` = "LOVE", `8` = "IDEOLOGY", `16` = "ENTERTAINMENT", `32` = "DISSATISFACTION", `64` = "OTHERS" )) %>%
  mutate(R1301B2K5 = recode_factor(as.vector(podes4$R1301B2K5), `1` = "PROPERTY" , `2` = "POWER", `4` = "LOVE", `8` = "IDEOLOGY", `16` = "ENTERTAINMENT", `32` = "DISSATISFACTION", `64` = "OTHERS" )) %>%
  mutate(R1301B5K5 = recode_factor(as.vector(podes4$R1301B5K5), `1` = "PROPERTY" , `2` = "POWER", `4` = "LOVE", `8` = "IDEOLOGY", `16` = "ENTERTAINMENT", `32` = "DISSATISFACTION", `64` = "OTHERS" ))
```
...
```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1302A = recode_factor(as.vector(podes4$R1302A), `1` = "YES,ALL" , `2` = "YES,SOME", `3` = "NO" ))
```
...
```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1302B = recode_factor(as.vector(podes4$R1302B), `1` = "SECURITY FORCE", `2` = "GOVERNMENT OFFICIAL", `4` = "PUBLIC FIGURE", `8` = "RELIGIOUS FIGURE", `16` = "OTHERS", `32` = "NONE" ))
```


Changing variable "R1303A" - type of crime that happened most often in the village within Last Year.

Variable R1303A01 - Theft

Variable R1303A02 - Robbery

Variable R1303A03 - Fraud/Embezzlement

Variable R1303A04 - Persecution

Variable R1303A05 - Arson

Variable R1303A06 - Rape/Crime Against Decency

Variable R1303A07 - Drug Abuse/Drug Trafficking

Variable R1303A08 - Gambling

Variable R1303A09 - Murder

Variable R1303A10 - Human Trafficking

Variable R1303A11 - Corruption

Variable R1303A ending with K3 refers to the presence of crime incident. We will recode these variables to 1 for yes and 0 for no.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1303A01K3 = recode_factor(as.vector(podes4$R1303A01K3), `1` = 1 , `2` = 0 )) %>%
  mutate(R1303A02K3 = recode_factor(as.vector(podes4$R1303A02K3), `1` = 1 , `2` = 0 )) %>%
  mutate(R1303A03K3 = recode_factor(as.vector(podes4$R1303A03K3), `1` = 1 , `2` = 0 )) %>%
  mutate(R1303A04K3 = recode_factor(as.vector(podes4$R1303A04K3), `1` = 1 , `2` = 0 )) %>%
  mutate(R1303A05K3 = recode_factor(as.vector(podes4$R1303A05K3), `1` = 1 , `2` = 0 )) %>%
  mutate(R1303A06K3 = recode_factor(as.vector(podes4$R1303A06K3), `1` = 1 , `2` = 0 )) %>%
  mutate(R1303A07K3 = recode_factor(as.vector(podes4$R1303A07K3), `1` = 1 , `2` = 0 )) %>%
  mutate(R1303A08K3 = recode_factor(as.vector(podes4$R1303A08K3), `1` = 1 , `2` = 0 )) %>%
  mutate(R1303A09K3 = recode_factor(as.vector(podes4$R1303A09K3), `1` = 1 , `2` = 0 )) %>%
  mutate(R1303A10K3 = recode_factor(as.vector(podes4$R1303A10K3), `1` = 1 , `2` = 0 )) %>%
  mutate(R1303A11K3 = recode_factor(as.vector(podes4$R1303A11K3), `1` = 1 , `2` = 0 ))
```


Variable R1303A ending with K4 refers to the the difference in the crime trend compared to a year ago if there was such a crime happening in the village. We will recode these variables to "REDUCING" for 1, "SAME" for 2 and "INCREASING" for 3.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1303A01K4 = recode_factor(as.vector(podes4$R1303A01K4), `1` = "REDUCING" , `2` = "SAME", `3` = "INCREASING" )) %>%
  mutate(R1303A02K4 = recode_factor(as.vector(podes4$R1303A02K4), `1` = "REDUCING" , `2` = "SAME", `3` = "INCREASING" )) %>%
  mutate(R1303A03K4 = recode_factor(as.vector(podes4$R1303A03K4), `1` = "REDUCING" , `2` = "SAME", `3` = "INCREASING" )) %>%
  mutate(R1303A04K4 = recode_factor(as.vector(podes4$R1303A04K4), `1` = "REDUCING" , `2` = "SAME", `3` = "INCREASING" )) %>%
  mutate(R1303A05K4 = recode_factor(as.vector(podes4$R1303A05K4), `1` = "REDUCING" , `2` = "SAME", `3` = "INCREASING" )) %>%
  mutate(R1303A06K4 = recode_factor(as.vector(podes4$R1303A06K4), `1` = "REDUCING" , `2` = "SAME", `3` = "INCREASING" )) %>%
  mutate(R1303A07K4 = recode_factor(as.vector(podes4$R1303A07K4), `1` = "REDUCING" , `2` = "SAME", `3` = "INCREASING" )) %>%
  mutate(R1303A08K4 = recode_factor(as.vector(podes4$R1303A08K4), `1` = "REDUCING" , `2` = "SAME", `3` = "INCREASING" )) %>%
  mutate(R1303A09K4 = recode_factor(as.vector(podes4$R1303A09K4), `1` = "REDUCING" , `2` = "SAME", `3` = "INCREASING" )) %>%
  mutate(R1303A10K4 = recode_factor(as.vector(podes4$R1303A10K4), `1` = "REDUCING" , `2` = "SAME", `3` = "INCREASING" )) %>%
  mutate(R1303A11K4 = recode_factor(as.vector(podes4$R1303A11K4), `1` = "REDUCING" , `2` = "SAME", `3` = "INCREASING" ))
```


Changing variable "R1303B" - Type of crime that happens most often

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1303B = recode_factor(as.vector(podes4$R1303B), `1` = "THEFT" , `2` = "ROBBERY", `3` = "FRAUD_EMBEZZLEMENT", `4` = "PERSECUTION", `5` = "ARSON", `6` = "RAPE_CRIME", `7` = "DRUG_ABUSE_TRAFFICKING", `8` = "GAMBLING", `9` = "MURDER", `10` = "HUMAN_TRAFFICKING", `11` = "CORRUPTION"))
```


Changing variable "R1304" - Villagers activity in maintaining the safety in the village within last year. We will recode these variables to 1 for Yes and 2 for No.

Variable R1304A - BUILDING_MAINTENANCE_SECURITY_POST

Variable R1304B - ESTABLISHING_SECURITY_GUARDS

Variable R1304C - RAISING_CIVIL_DEFENSE

Variable R1304D - REPORTING_GUEST_STAY_MORE_THAN_24_HOURS

Variable R1304E - ACTIVATION_OF_SECURITY_SYSTEM_FROM_CITIZEN_INITIATIVE

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1304A = recode_factor(as.vector(podes4$R1304A), `1` = 1 , `2` = 0 )) %>%
  mutate(R1304B = recode_factor(as.vector(podes4$R1304B), `3` = 1 , `4` = 0 )) %>%
  mutate(R1304C = recode_factor(as.vector(podes4$R1304C), `5` = 1 , `6` = 0 )) %>%
  mutate(R1304D = recode_factor(as.vector(podes4$R1304D), `7` = 1 , `8` = 0 )) %>%
  mutate(R1304E = recode_factor(as.vector(podes4$R1304E), `1` = 1 , `2` = 0 ))
```

Variable R1305 refers to the number of civil defense officer/police in the village/sub-district. There's no need to recode this variable as it's a continuous variable.
...
Variable R1306B refers to the number of police post/ police office that are used and unused, both are continuous variables.

Variable R1306C1 refers to the estimated distance to the nearest police post/police station.

Changing variable "R1306C2" - Convenience to reach the nearest police station. 

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1306C2 = recode_factor(as.vector(podes4$R1306C2), `1` = "VERY EASY" , `2` = "EASY", `3` = "HARD", `4` = "VERY HARD" ))
```

Variable 1307 refers to the number of suicide victims in the village/sub-district in the last year.

Changing variable "R1308A" - presence of gathering places for the street children in the village. 

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1308A = recode_factor(as.vector(podes4$R1308A), `1` = 1 , `2` = 0))
```

Changing variable "R1308B" - presence of gathering places for the homeless/beggar in the village.
...
Changing variable "R1309" - presence of Localization/Location of Sex Workers (PSK)

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1309 = recode_factor(as.vector(podes4$R1309), `1` = 1 , `2` = 0))
```

- Finance and village assets

Changing variable "R1403A" - Availability of village information system

while variable "R1403B" refers to Usage of village financial system

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1403A = recode_factor(as.vector(podes4$R1403A), `1` = "YES,RENEWED" , `2` = "YES,NOT RENEWED", `3` = "NONE")) %>%
  mutate(R1403B = recode_factor(as.vector(podes4$R1403B), `1` = "YES,RENEWED" , `2` = "YES,NOT RENEWED", `3` = "NONE"))
```


Changing variable "R1404" refers to presence and usage of Village Owned Enterprise and village assets. 

Variable R1404B - village land

Variable R1404C - village buildings (ex: village hall, etc.)

Variable R1404D - village market (animal market, fish auction, agricultural product auction, etc.) 

Variable R1404E - other village assets

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1404B = recode_factor(as.vector(podes4$R1404B), `1` = 1 , `2` = 0)) %>%
  mutate(R1404C = recode_factor(as.vector(podes4$R1404C), `1` = "YES,USED" , `2` = "YES,NOT USED", `3` = "NO")) %>%
  mutate(R1404D = recode_factor(as.vector(podes4$R1404D), `1` = "YES,FUNCTIONAL" , `2` = "YES,NOT FUNCTIONAL", `3` = "NO")) %>%
  mutate(R1404E = recode_factor(as.vector(podes4$R1404E), `1` = 1 , `2` = 0))
```

Changing variable "R1405A1" - presence of VILLAGE MEDIUM-TERM DEVELOPMENT PLAN (RPJM) 

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1405A1 = recode_factor(as.vector(podes4$R1405A1), `1` = 1 , `2` = 0))
```

Variable R1405A2 refers to the period of the village RPJM

Changing variable "R1405B" - presence of Village Government Work Plan (RKP Desa) in 2018

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1405B = recode_factor(as.vector(podes4$R1405B), `3` = 1 , `4` = 0))
```

Variable R1405C and R1405D refers to number of village rules in 2017 and village head rules in 2017 respectively, they are both continuous variables.

Changing variable "R1406A" refers to the presence OF village cooperation with other villages in 2018 while variable "R1406B" refers to the presence of village cooperation with third parties in 2018.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1406A = recode_factor(as.vector(podes4$R1406A), `1` = 1 , `2` = 0)) %>%
  mutate(R1406B = recode_factor(as.vector(podes4$R1406B), `3` = 1 , `4` = 0))
```

Changing variable "R1407" - presence of local village guides 

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1407 = recode_factor(as.vector(podes4$R1407), `1` = "YES,ACTIVE" , `2` = "YES,NOT ACTIVE", `3` = "NONE"))
```


- development and empowerment of village

Variable R1601A refers to the programmes/development initiatives in the village from 2015 to 2017.

Variable R1601A1 - transportation infrastructure

Variable R1601A2 - energy infrastructure

Variable R1601A3 - information communication tech (ICT) infrastructure

Variable R1601A4 - sanitation and clean water infrastructure

Variable R1601A5 - education, culture and health infrastructure

Variable R1601A6 - trading services infrastructure

Variable R1601A7 - farming production and small industries infrastructure

Variable R1601A8 - recreation and tourism infrastructure

Variable R1601A9 - disaster mitigation and environmental conservation infrastructure

Variable R1601A10 - government support infrastructure

Variable R1601 ending with K2 refers to the presence of such programmes/initiatives. These variables will be recoded into 1 for yes and 0 for no.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1601A1K2 = recode_factor(as.vector(podes4$R1601A1K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601A2K2 = recode_factor(as.vector(podes4$R1601A2K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601A3K2 = recode_factor(as.vector(podes4$R1601A3K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601A4K2 = recode_factor(as.vector(podes4$R1601A4K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601A5K2 = recode_factor(as.vector(podes4$R1601A5K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601A6K2 = recode_factor(as.vector(podes4$R1601A6K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601A7K2 = recode_factor(as.vector(podes4$R1601A7K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601A8K2 = recode_factor(as.vector(podes4$R1601A8K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601A9K2 = recode_factor(as.vector(podes4$R1601A9K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601A10K2 = recode_factor(as.vector(podes4$R1601A10K2), `1` = 1 , `2` = 0))
```

Variable R1601 ending with K3 refers to the source of fund. These variables will be recoded as such below.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1601A1K3 = recode_factor(as.vector(podes4$R1601A1K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601A2K3 = recode_factor(as.vector(podes4$R1601A2K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601A3K3 = recode_factor(as.vector(podes4$R1601A3K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601A4K3 = recode_factor(as.vector(podes4$R1601A4K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601A5K3 = recode_factor(as.vector(podes4$R1601A5K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601A6K3 = recode_factor(as.vector(podes4$R1601A6K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601A7K3 = recode_factor(as.vector(podes4$R1601A7K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601A8K3 = recode_factor(as.vector(podes4$R1601A8K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601A9K3 = recode_factor(as.vector(podes4$R1601A9K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601A10K3 = recode_factor(as.vector(podes4$R1601A10K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" ))
```

Variable R1601 ending with K4 refers to the administrator/executive of such programmes/initiatives. These variables will be recoded as such below. 
...
podes4 <- podes4 %>% mutate(R1601A1K4 = recode_factor(as.vector(podes4$R1601A1K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A2K4 = recode_factor(as.vector(podes4$R1601A2K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A3K4 = recode_factor(as.vector(podes4$R1601A3K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A4K4 = recode_factor(as.vector(podes4$R1601A4K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A5K4 = recode_factor(as.vector(podes4$R1601A5K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A6K4 = recode_factor(as.vector(podes4$R1601A6K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A7K4 = recode_factor(as.vector(podes4$R1601A7K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A8K4 = recode_factor(as.vector(podes4$R1601A8K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A9K4 = recode_factor(as.vector(podes4$R1601A9K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A10K4 = recode_factor(as.vector(podes4$R1601A10K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" ))
```

Variable R1601 ending with K5 refers to the direct beneficiaries of such programmes/initiatives. These variables will be recoded as such below. 
...
podes4 <- podes4 %>% mutate(R1601A1K5 = recode_factor(as.vector(podes4$R1601A1K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A2K5 = recode_factor(as.vector(podes4$R1601A2K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A3K5 = recode_factor(as.vector(podes4$R1601A3K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A4K5 = recode_factor(as.vector(podes4$R1601A4K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A5K5 = recode_factor(as.vector(podes4$R1601A5K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A6K5 = recode_factor(as.vector(podes4$R1601A6K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A7K5 = recode_factor(as.vector(podes4$R1601A7K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A8K5 = recode_factor(as.vector(podes4$R1601A8K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A9K5 = recode_factor(as.vector(podes4$R1601A9K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601A10K5 = recode_factor(as.vector(podes4$R1601A10K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" ))
```


Variable R1601B community empowerment programme in the village from 2015 to 2017.

Variable R1601B1 - EDU_HEALTH_PUBLIC_CULTURE_EMPOWERMENT 

Variable R1601B2 -  VILLAGE_RESIDENTIAL_NEIGHBOURHOOD_MGMT_EMPOWERMENT

Variable R1601B3 - VILLAGE_TRANSPORTATION_MGMT_EMPOWERMENT  

Variable R1601B4 - RENEWABLE_ENERGY_DEVELOPMENT_EMPOWERMENT

Variable R1601B5 - INFORMATION_COMMUNICATION_MGMT_EMPOWERMENT

Variable R1601B6 - AGRI_BASED_PRODUCTIVE_BUSI_NON_AGRI_VILLAGE_SMALL_BUSI_MGMT_EMPOWERMENT

Variable R1601B7 - NATURE_CONSERVE_AWARENESS_DISASTER_MGMT_EMPOWERMENT

Variable R1601B8 - COMMUNITY_ROLE_IMPROVE_VILLAGE_GOVERNANCE_EMPOWERMENT

Variable R1601B9 - QUALITY_CAPACITY_OF_VILLAGE_COMMUNITY_EMPOWERMENT

Variable R1601B10 - ESTABLISHMENT_DEVELOPMENT_VILLAGE_GOV_ENTERPRISE_EMPOWERMENT

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1601B1K2 = recode_factor(as.vector(podes4$R1601B1K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601B2K2 = recode_factor(as.vector(podes4$R1601B2K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601B3K2 = recode_factor(as.vector(podes4$R1601B3K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601B4K2 = recode_factor(as.vector(podes4$R1601B4K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601B5K2 = recode_factor(as.vector(podes4$R1601B5K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601B6K2 = recode_factor(as.vector(podes4$R1601B6K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601B7K2 = recode_factor(as.vector(podes4$R1601B7K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601B8K2 = recode_factor(as.vector(podes4$R1601B8K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601B9K2 = recode_factor(as.vector(podes4$R1601B9K2), `1` = 1 , `2` = 0)) %>%
  mutate(R1601B10K2 = recode_factor(as.vector(podes4$R1601B10K2), `1` = 1 , `2` = 0))
```

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1601B1K3 = recode_factor(as.vector(podes4$R1601B1K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601B2K3 = recode_factor(as.vector(podes4$R1601B2K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601B3K3 = recode_factor(as.vector(podes4$R1601B3K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601B4K3 = recode_factor(as.vector(podes4$R1601B4K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601B5K3 = recode_factor(as.vector(podes4$R1601B5K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601B6K3 = recode_factor(as.vector(podes4$R1601B6K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601B7K3 = recode_factor(as.vector(podes4$R1601B7K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601B8K3 = recode_factor(as.vector(podes4$R1601B8K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601B9K3 = recode_factor(as.vector(podes4$R1601B9K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" )) %>% 
  mutate(R1601B10K3 = recode_factor(as.vector(podes4$R1601B10K3), `1` = "REGIONAL BUDGET", `2` = "VILLAGE GENERATED REVENUE", `4` = "COMMUNITY", `8` = "OTHERS" ))
```
...
podes4 <- podes4 %>% mutate(R1601B1K4 = recode_factor(as.vector(podes4$R1601B1K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B2K4 = recode_factor(as.vector(podes4$R1601B2K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B3K4 = recode_factor(as.vector(podes4$R1601B3K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B4K4 = recode_factor(as.vector(podes4$R1601B4K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B5K4 = recode_factor(as.vector(podes4$R1601B5K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B6K4 = recode_factor(as.vector(podes4$R1601B6K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B7K4 = recode_factor(as.vector(podes4$R1601B7K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B8K4 = recode_factor(as.vector(podes4$R1601B8K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B9K4 = recode_factor(as.vector(podes4$R1601B9K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B10K4 = recode_factor(as.vector(podes4$R1601B10K4), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" ))
```
...
podes4 <- podes4 %>% mutate(R1601B1K5 = recode_factor(as.vector(podes4$R1601B1K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B2K5 = recode_factor(as.vector(podes4$R1601B2K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B3K5 = recode_factor(as.vector(podes4$R1601B3K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B4K5 = recode_factor(as.vector(podes4$R1601B4K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B5K5 = recode_factor(as.vector(podes4$R1601B5K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B6K5 = recode_factor(as.vector(podes4$R1601B6K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B7K5 = recode_factor(as.vector(podes4$R1601B7K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B8K5 = recode_factor(as.vector(podes4$R1601B8K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B9K5 = recode_factor(as.vector(podes4$R1601B9K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" )) %>%
  mutate(R1601B10K5 = recode_factor(as.vector(podes4$R1601B10K5), `1` = "POOR POPULATION", `2` = "FARMERS FISHERMAN", `4` = "COMMUNITY BUSINESS GROUP", `8` = "MAJORITY CITIZENS", `16` = "PRIVATE", `32` = "OTHERS" ))
```


- INFORMATION OF VILLAGE/DISTRICT GOVERNMENT PERSONNEL 

Changing variable "R1701A" refers to the village head/district head while variable "R1701B" refers to the village secretary..

Variable R1701 ending with K2 refers to the presence of such position. This will be recoded to 1 for yes and 0 for no.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1701AK2 = recode_factor(as.vector(podes4$R1701AK2), `1` = 1 , `2` = 0 )) %>% 
  mutate(R1701BK2 = recode_factor(as.vector(podes4$R1701BK2), `1` = 1 , `2` = 0 ))
```

Variable R1701 ending with K3 refers to the age of village head/secretary. This is a continuous variable.

Variable R1701 ending with K4 refers to the gender, these variables will be recoded as "MALE" for 1 and "FEMALE" for 2.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1701AK4 = recode_factor(as.vector(podes4$R1701AK4), `1` = "MALE" , `2` = "FEMALE")) %>%
  mutate(R1701BK4 = recode_factor(as.vector(podes4$R1701BK4), `1` = "MALE" , `2` = "FEMALE"))
```

Variable R1701 ending with K5 refers to the highest education undergone by village head/secretary. These variables will be recoded such as below.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4 <- podes4 %>% mutate(R1701AK5 = recode_factor(as.vector(podes4$R1701AK5), `1` = "NEVER SCHOOLED", `2` = "NEVER FINISHED ELEMENTARY SCHOOL", `3` = "FINISHED ELEMENTARY SCHOOL", `4` = "JUNIOR HIGH SCHOOL", `5` = "SENIOR HIGH SCHOOL", `6` = "ACADEMY ASSOCIATE DEGREE", `7` = "UNDERGRADUATE", `8` = "GRADUATE", `9` = "POST GRADUATE" )) %>% 
  mutate(R1701BK5 = recode_factor(as.vector(podes4$R1701BK5), `1` = "NEVER SCHOOLED", `2` = "NEVER FINISHED ELEMENTARY SCHOOL", `3` = "FINISHED ELEMENTARY SCHOOL", `4` = "JUNIOR HIGH SCHOOL", `5` = "SENIOR HIGH SCHOOL", `6` = "ACADEMY ASSOCIATE DEGREE", `7` = "UNDERGRADUATE", `8` = "GRADUATE", `9` = "POST GRADUATE" ))
```


Variable R1702 refers to the number of government personnel or agencies. These are all continuous variables.
...
```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
podes4_final <- podes4 %>%
  select("SHAPE", "PROVINCE_ID", "PROVINCE", "CITY_ID", "CITY", "DISTRICT_ID", "DISTRICT", "VILLAGE_ID", "VILLAGE", "THEFT", "ROBBERY", "FRAUD_EMBEZZLEMENT", "PERSECUTION", "ARSON", "RAPE_CRIME", "DRUG_ABUSE_TRAFFICKING", "GAMBLING", "MURDER", "HUMAN_TRAFFICKING", "CORRUPTION",  "NUM_CIVIL_DEFENSE_OFFICER", "VILLAGE_INFORMATION_SYSTEM", "USAGE_OF_VILLAGE_FINANCIAL_SYSTEM","VILLAGE_OWNED_ENTERPRISE_LAND", "VILLAGE_BUILDINGS","VILLAGE_MARKET", "COOPERATION_BETWEEN_VILLAGES_2018", "VILLAGE_COOPERATION_WITH_THIRD_PARTIES_2018",
"TRANSPORTATION_INFRASTRUCTURE_DEVELOPMENT", "ENERGY_INFRASTRUCTURE", "INFO_COMM_INFRASTRUCTURE", "SANITATION_INFRASTRUCTURE", "EDUCATION_CULTURE_HEALTH_INFRASTRUCTURE", "TRADING_SERVICES_INFRASTRUCTURE", "FARMING_PRODUCTION_SMALL_INDUSTRY_INFRASTRUCTURE", "RECREATION_TOURISM_INFRASTRUCTURE", "DISASTER_MITIGATION_ENV_CONSERVATION_INFRASTRUCTURE", "GOVT_SUPPORT_INFRASTRUCTURE")
```

```{r}
summary(podes4_final)
```
...
We will also do inner joins on the subset podes dataframes to retrieve the initial dataframe with the metrics we would like to analyse for the Project. The join condition will be on similar fields as above. 
...
Let's write/download the final combined podes dataset with the East Kalimantan shapefile so that we can load it to our R shiny application.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
head(as.data.frame(eastkalimantan.podes))
```
...
Below is the function for plotting tmap for different variables of the podes data.

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=TRUE}
map_function_single <- function(x,col,style,breaks,palette,z){
  tm_shape(x)+
    tm_fill(col, 
            style = style,
            breaks = breaks,
...
map_function_multiple <- function(x,col,style,breaks,palette,z,labels){
  tm_shape(x)+
    tm_fill(col, 
            style = style,
            breaks = breaks,
...
```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
healthcare1 <- map_function_single(eastkalimantan.podes, "UNIVERSAL_HEALTHCARE_PROGRAMME_POP_2017", "quantile", NULL, "Blues", "Population with universal healthcare in 2017")

healthcare2 <- map_function_single(eastkalimantan.podes, "HOSPITAL_NUM", "fixed", c(0,1,2), "Blues", "Number of hospitals")

tmap_arrange(healthcare1, healthcare2, ncol = 2)
```
- HOSPITAL AND HEALTHCARE FACILITIES in East Kalimantan

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
healthcare_facilities_map <- map_function_multiple(eastkalimantan.podes, c("MATERNITY_HOSPITAL_NUM", "PUBLIC_HEALTH_CLINIC_INPATIENT_CARE_NUM", "PUBLIC_HEALTH_CLINIC_OUTPATIENT_CARE_NUM", "POLYCLINIC_NUM", "GP_NUM", "VILLAGE_HEALTH_POST_NUM", "PHARMACY_NUM", "DRUGSTORE_NUM"), "pretty", NULL, "Blues", "Healthcare Facilities", c("Number of Maternity Hospital", "Inpatient Public Health Clinic", "Outpatient Public Health Clinic", "Number of Polyclinic", "Number of General Practitioner", "Number of village health post", "Number of pharmacies", "Number of drugstores")) 
healthcare_facilities_map
```

```{r , echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
healthcare3 <- map_function(eastkalimantan.podes, "MATERNITY_HOSPITAL_NUM ", "fixed", c(0,1,2), "Blues", "Number of Maternity Hospital")

healthcare4 <- map_function(eastkalimantan.podes, "PUBLIC_HEALTH_CLINIC_INPATIENT_CARE_NUM ", "fixed", c(0,1,2), "Blues", "Inpatient Public Health Clinic")

healthcare5 <- map_function(eastkalimantan.podes, "PUBLIC_HEALTH_CLINIC_OUTPATIENT_CARE_NUM ", "fixed", c(0,1,2), "Blues", "Outpatient Public Health Clinic")

healthcare6 <- map_function(eastkalimantan.podes, "POLYCLINIC_NUM", "fixed", c(0,1,2,3,4,5), "Blues", "Number of Polyclinic")

healthcare7 <- map_function(eastkalimantan.podes, "GP_NUM", "pretty", NULL, "Blues", "Number of General Practitioner")

healthcare8 <- map_function(eastkalimantan.podes, "VILLAGE_HEALTH_POST_NUM", "fixed", c(0,1,2,3), "Blues", "Number of village health post")

healthcare9 <- map_function(eastkalimantan.podes, "PHARMACY_NUM", "pretty", NULL, "Blues", "Number of pharmacies")

healthcare10 <- map_function(eastkalimantan.podes, "DRUGSTORE_NUM", "pretty", NULL, "Blues", "Number of drugstores")

tmap_arrange(healthcare3, healthcare4, healthcare5, healthcare6, healthcare7, healthcare8, healthcare9, healthcare10, ncol = 4, nrow = 2)
```
...
## 5.1 Generate Correlation Plot 
```{r}
#podes3.subset.cor = cor(podes3.subset[,6:91], use = "complete.obs") # use complete.obs to ignore NAs 
